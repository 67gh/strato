...
namespace skyline {
    ...
    class Settings {
      ...
      public:
        ...
        Setting<float> renderScaleFactor; //!< Render resolution multiplier: 0.5=half, 1.0=native, 2.0=2x
        Setting<u32> performanceMode; //!< 0=Normal, 1=Extreme Compatibility, 2=Extreme Performance
