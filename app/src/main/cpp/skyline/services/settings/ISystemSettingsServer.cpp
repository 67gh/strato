...
namespace skyline::service::settings {
    ...
    Result ISystemSettingsServer::GetFirmwareVersion(type::KSession &session, ipc::IpcRequest &request, ipc::IpcResponse &response) {
        request.outputBuf.at(0).as<SysVerTitle>() = {.major=22, .minor=1, .micro=0, .revMajor=0, .revMinor=0, .platform="NX", .verHash="0000000000000000000000000000000000000000", .dispVer="22.1.0", .dispTitle="NintendoSDK Firmware for NX 22.1.0-0.0"};
        return {};
    }
